                ...
                <div class="col-12">
                    <div class="card">
                        <div class="profile-image">
                            <img src="https://image.eveonline.com/Character/{{$character->id}}_512.jpg"
                                 class="card-img-top">
                        ...
                        <div class="card-footer text-center">
                            ...
                            <a href="https://evewho.com/pilot/{{str_replace(' ', '+', $character->name)}}"
                               title="EveWho">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="alert-danger alert mt-2">
                            The Character token is expired, please re-add the character to the system!
                        </div>
                    </div>
                </div>
            @endif
