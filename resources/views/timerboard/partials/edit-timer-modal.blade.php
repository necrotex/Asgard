                            ...
                            <form class="form-horizontal timepicker-form" method="post" action="{{route('timerboard.edit', 0000)}}">
                                ...
                                <div class="center-timepicker-group">
                                    <div class="form-group timepicker-group">
                                        ...
                                        <input type="number" class="form-control timepicker countdown_days" name="time-days" placeholder="0" step="1" min="0" required="required">
                                    </div>

                                    <div class="form-group timepicker-group">
                                        <label for="time-hours">Hours</label>
                                        <input type="number" class="form-control timepicker countdown_hours" name="time-hours" placeholder="0" min="0" step="1" max="23" required="required">
                                    </div>

                                    <div class="form-group timepicker-group">
                                        <label for="time-minutes">Min</label>
                                        <input type="number" class="form-control timepicker countdown_min" name="time-minutes" placeholder="0" min="0" step="1" max="59" required="required">
                                    </div>

                                    <div class="form-group timepicker-group">
                                        <label for="time-seconds">Sec</label>
                                        <input type="number" class="form-control timepicker countdown_sec" name="time-seconds" placeholder="0" min="0" step="1" max="59" required="required">
                                    </div>
